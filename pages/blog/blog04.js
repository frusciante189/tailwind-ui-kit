    ...
    <section className="lg:py-20 sm:py-16 py-12">
      <div className="max-w-7xl mx-auto lg:px-8 sm:px-6 px-4">
        ...
        <div className="sm:mt-12 mt-8">
          <svg
            className="h-4 w-auto text-gray-400 sm:mx-auto"
            viewBox="0 0 172 16"
            fill="none"
            stroke="currentColor"
        ...
        <div className="sm:mt-16 mt-12 max-w-xl mx-auto">
          <div className="flow-root">
            <div className="-my-8 divide-y-2">
              <div className="relative sm:flex sm:items-center py-8 group">
                <div className="rounded-2xl overflow-hidden flex-shrink-0 w-32 h-32">
                  <img
